...
describe('centsToDecimals function', () => {
  ...
  function checkTheString(string) {
    ...
    if (typeof string !== 'st' || isNaN(centValue)) {
      return undefined;
    }};
  }

// asking me for semi colon after for loop, I'm not sure why. It's keeping my tests from running. 
  ...
  it('should returns undefined when NaN value is passed as a parameter.', () => {
    ...
    // ... complete the test assertion below
    expect(checkTheString(NaN)).toEqual(undefined);
  });
